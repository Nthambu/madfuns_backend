...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Initialize Paystack transaction — returns accessCode + reference' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: '{ accessCode, authorizationUrl, reference, breakdown }' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid event or ticket type' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [initialize_payment_dto_1.InitializePaymentDto]),
    __metadata("design:returntype", void 0)
], CheckoutController.prototype, "initializePayment", null);
__decorate([
    (0, common_1.Post)('verify'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Verify payment reference with Paystack and save order' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: '{ orderId, orderNumber }' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Payment not completed or invalid reference' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Paystack webhook — configure this URL in Paystack dashboard' }),
