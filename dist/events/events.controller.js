...
let EventsController = class EventsController {
    ...
    create(dto) { return this.eventsService.create(dto); }
    update(id, dto) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List active events (public)' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get one event (public)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List ALL events including inactive (admin)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Soft-delete event (admin)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
